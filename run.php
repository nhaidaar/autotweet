...
$post = 'authenticity_token='.$auth.'&batch_mode=off&is_permalink_page=false&place_id=&status='.rand(1111,9999).' Mau+cari+mutual+baru+help+rt+like+thanks&tagged_users=';
